...
class VariantSelects extends HTMLElement {
  ...
  updateMedia() {
    ...
    mediaGalleries.forEach(mediaGallery => mediaGallery.setActiveMedia(`${this.dataset.section}-${this.currentVariant.featured_media.id}`, true,mediaGallery.findFilterMedia(mediaGallery,this.currentVariant)));
